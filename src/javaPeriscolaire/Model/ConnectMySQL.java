...
/*-----------------------Notes-----------------------
Cette version de la connexion à la base de données est rudimentaire,
il faudrait faire en sorte de n'avoir qu'une bdd commune au lieu de 3 bdd locale
De plus le système de prise en compte des divers type de requete est plus que sommaire
...
public class ConnectMySQL
{
	public static ArrayList<ArrayList> main(String req)
	{
		...
		try
		{
    		...
    		while (res.next()) { //On parcours chaque résultat du result set
